	...
	<table width="1570" cellspacing="0" bgcolor="E0DDAA">
		<tr height="50px">
			...
			<td align="right">
					...
					<a href="../controllers/logout.php" style="text-decoration: none; color: darkred;"><b style="font-size: 20px; font-family: calibri;">Logout</b></a> |
			</td>
		</tr>
		<tr>
			<td colspan="3">
				<img src="../assets/1.jpg" alt="Car Image" width="1570" height="250">
			</td>
		</tr>
