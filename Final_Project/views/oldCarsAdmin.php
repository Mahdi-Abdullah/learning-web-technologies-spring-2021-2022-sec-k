			...
			<td bgcolor="141E27" valign="Top" colspan="3">
				<table width="1500px" align="center" border="1">
					...
					<tr style="font-size: 20px; font-family: calibri; color: white;">
						...
						<td><?=$userArray[4]?></td>
						<td>
							<a href="../views/editOldCar.php?id=<?=$userArray[1]?>" style="font-size: 20px; font-family: calibri; color: white; text-decoration: none;"> <b>EDIT</b> </a> | 
					    	<a href="../views/deleteOldCar.php?id=<?=$userArray[1]?>" style="font-size: 20px; font-family: calibri; color: white; text-decoration: none;"> <b>DELETE</b> </a> 
						</td>
